...
export default function CustomDrawerContent(props: any) {
  ...
  const aplicarFiltro = () => {
    console.log('Temas selecionados que serão enviados:', temasSelecionados);
    props.navigation.navigate('Filtro', { filtros: temasSelecionados });
  };
  ...
  return (
    <DrawerContentScrollView {...props}>
      ...
      <View style={styles.filtroContainer}>
        <Text style={styles.filtroTitulo}>Temas</Text>
